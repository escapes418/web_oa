<template>
  <div class="toolbar">
    ...
    ></i>
    <el-button @click="saveData" type="primary">保存流程图数据</el-button>
    <el-button @click="goBack">返回</el-button>
  </div>
</template>

<script>
import { saveFlow } from '@/api/g6'
...
export default {
  ...
  mounted(){
    ...
    link.type = 'text/css'
    link.rel = 'stylesheet'
    link.href = 'https://at.alicdn.com/t/font_598462_3xve1872wizzolxr.css'
  ...
  methods: {
    ...
    bindEvent() {
      ...
      eventBus.$on("nodeselectchange", () => {
        this.selectedItem = self.graph.findAllByState("node", "selected");
