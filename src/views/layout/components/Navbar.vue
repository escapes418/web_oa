...
export default {
    ...
    created() {
        ...
        //  if(this.avatar){
        //    this.headUrl = this.avatar+ '?imageView2/1/w/80/h/80'
        //  }else{
        //    this.headUrl = 'http://ropservice-file.ipnavi.cn:8106/74/13/490cafba4a8c91603fe8838a579b3dab.jpg'
        //  }
        ...
        // let url = "ws://192.168.12.43:8089/OA/webSocketServer"+"?sessionid=ed7bef4a9f3a49bba3c23c7d7aeffb6e"
        // //+this.userIn.id
    ...
    methods: {
        ...
        logout() {
            this.$store.dispatch('LogOut').then(() => {
                ...
                // this.$store.commit('RELOAD_ROUTERS')
                this.$router.push({
                    path: '/login'
                })
            })
