    ...
    <div class="sjb-container calendar-list-container">
        <div class="filter-container">
            ...
            <div class="toolbar-item">
                ...
                <el-select clearable style="width: 120px" class="filter-item" v-model="listQuery.travelStatus" placeholder="请选择">
            ...
            <div class="toolbar-item">
                ...
                <el-button class="filter-item" style="margin-left: 10px;" @click="handleCreate" type="primary" icon="el-icon-edit">新建出差申请</el-button>
            </div>
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row style="width: 100%">
            ...
            <el-table-column align="center" label="流程名称" width="350px">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="项目负责人" width="100px">
                <template slot-scope="scope">
                    <span>{{scope.row.projectPersonel}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="费用总额" width="100px">
                <template slot-scope="scope">
                    <span>{{scope.row.budgetTotal}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="提交人" width="70px">
                <template slot-scope="scope">
            ...
            <el-table-column width="110px" align="center" label="状态">
                <template slot-scope="scope">
                    <span>{{ scope.row.travelStatusValue }}</span>
                </template>
            </el-table-column>
...
import { 
    queryMyTravelFlowList,//Web端出差申请-查询列表
    fetchProDic //项目名称
 } from "@/api/traveling";
...
export default {
    ...
    methods: {
        ...
        handleCreate() {
            this.$router.push({ path: "/me/travelingForm" });
        }
    }
};
</script>
