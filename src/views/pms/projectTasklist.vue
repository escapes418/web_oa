<template>
  <div class="sjb-container calendar-list-container ">
    <div class="filter-container">
      ...
      <div class="toolbar-item">
        ...
        <el-input
          ...
          class="filter-item"
          placeholder="请输入姓名"
          v-model.trim="listQuery.taskCreateName"
        >
        </el-input>
      </div>
      <div class="toolbar-item">
        ...
        <el-input
          ...
          class="filter-item"
          placeholder="请输入姓名"
          v-model.trim="listQuery.principalName"
        >
        </el-input>
      </div>
      <div class="toolbar-item">
      ...
      <div class="toolmore-control">
        <el-button icon="el-icon-arrow-up" v-if="toolexpand" class="toolmore-control-btn" @click="toolexpand = false"
          >收起</el-button
        >
        <el-button icon="el-icon-arrow-down" v-else class="toolmore-control-btn" @click="toolexpand = true"
          >展开</el-button
        >
      </div>
        ...
        <div v-show="toolexpand">
          <div class="toolbar-row">
            <div class="toolbar-item">
              ...
              <el-date-picker
                v-model="listQuery.timeRangeStart"
                type="daterange"
                class="filter-item"
                style="width:287px"
                placeholder="选择日期范围"
            ...
            <div class="toolbar-item">
              ...
              <el-date-picker
                v-model="listQuery.timeRangeEnd"
                type="daterange"
                class="filter-item"
                style="width:287px"
                placeholder="选择日期范围"
            ...
            <div class="toolbar-item" v-if="activeName != 0">
              ...
              <el-date-picker
                v-model="listQuery.timeRangeFinish"
                type="daterange"
                class="filter-item"
                style="width:287px"
                placeholder="选择日期范围"
    ...
    <el-dialog
      ...
      width="25%"
      :center="true"
      @close="dialogMarketVisible = false"
    >
      ...
      <el-tree
        ...
        check-strictly
        :props="defaultProps"
        @check-change="handleMarketClick"
        :filter-node-method="marketNode"
        ref="marketTree"
      ></el-tree>
  ...
  mounted() {
    ...
    function filterResign(memberList) {
      ...
      for (var i = memberList.length - 1; i >= 0; i--) {
        if (
          ids.indexOf(memberList[i].id) == "-1" &&
          memberList[i].type == "1" &&
          memberList[i].userInfo.length == "0"
        ) {
  ...
  methods: {
    ...
    reduceParams($$imData) {
      ...
      const $$postData = $$imData
        ...
        .delete("timeRange")
        .delete("timeRangeStart")
        .delete("timeRangeEnd")
        .delete("timeRangeFinish");
