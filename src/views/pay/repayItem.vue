<template>
    <tr>
        ...
        <td>
            <el-cascader :options="subsTree" v-model="itemData.subject" @change="subjectOnChange" label="value" :clearable="true" style="width:100%">
            </el-cascader>
        </td>
        <td>
            <el-input v-model.number="itemData.billNum" type="number"></el-input>
        </td>
        <td>
            <el-input auto-complete="off" v-model.number="itemData.expenseAmt" type="number"></el-input>
        </td>
        <td>
...
export default {
    ...
    computed: {
        ...
        canUpload() {
            ...
            if (this.itemData.subConfList.length == 0) {
                return true;
            } else {
                return false;
            }
