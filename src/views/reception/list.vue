    ...
    <div class="sjb-container calendar-list-container">
        <div class="filter-container">
            ...
            <div class="toolbar-item">
                ...
                <el-select clearable style="width: 120px" class="filter-item" v-model="listQuery.recpStatus" placeholder="请选择">
            ...
            <div class="toolbar-item">
                ...
                <el-select filterable remote clearable style="width: 220px" class="filter-item" v-model="listQuery.projectId" placeholder="请输入项目名称" :remote-method="searchProject">
            ...
            <div class="toolbar-item">
                ...
                <el-button class="filter-item" style="margin-left: 10px;" @click="handleCreate" type="primary" icon="el-icon-edit">新建接待申请</el-button>
            </div>
        ...
        <el-table-column align="center" label="接待主题">
            <template slot-scope="scope">
                <span class="ignore-detail" :title="scope.row.recpTheme">{{scope.row.recpTheme}}</span>
            </template>
        </el-table-column>
        ...
        <el-table-column width="70px" align="center" label="项目负责人">
            <template slot-scope="scope">
                <span>{{scope.row.projectPersonel}}</span>
            </template>
        </el-table-column>
        <el-table-column width="70px" align="center" label="预计接待人数">
            <template slot-scope="scope">
                <span >{{scope.row.recpNum}}</span>
            </template>
        </el-table-column>
        <el-table-column width="110px" align="center" label="预计接待时间">
            <template slot-scope="scope">
                <span class="ignore-detail" :title="scope.row.recpTime">{{scope.row.recpTime | stamp2TextDate}}</span>
            </template>
        </el-table-column>
        <el-table-column width="70px" align="center" label="预计陪客人数">
            <template slot-scope="scope">
                <span>{{scope.row.recpParticNum}}</span>
            </template>
        </el-table-column>
        ...
        <el-table-column width="60px" align="center" label="提交人">
            <template slot-scope="scope">
        ...
        <el-table-column width="110px"  align="center" label="提交时间">
            <template slot-scope="scope">
                <span class="ignore-detail" :title="scope.row.applyTime">{{scope.row.applyTime | stamp2TextDate}}</span>
            </template>
        </el-table-column>
...
import { fetchList , fetchProDic } from '@/api/reception'
...
export default {
    ...
    methods: {
        ...
        handleCreate() {
            this.$router.push({path: '/me/recepForm'})
        }
    }
}
</script>
